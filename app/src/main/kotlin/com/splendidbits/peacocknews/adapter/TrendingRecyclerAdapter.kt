package com.splendidbits.peacocknews.adapter
...
import com.splendidbits.peacocknews.helper.*
import com.splendidbits.peacocknews.model.Item
import com.splendidbits.peacocknews.view.AbstractNewsItemHolder
import com.splendidbits.peacocknews.view.NewsItemArticleHolder
import com.splendidbits.peacocknews.view.NewsItemFeaturedHolder
...
class TrendingRecyclerAdapter(val context: Context, private val picasso: Picasso) :
    ...
    override fun onBindViewHolder(viewHolder: AbstractNewsItemHolder, position: Int) {
        ...
        if (viewHolder is NewsItemFeaturedHolder) {
            ...
            viewHolder.pillText.text = if (item.breaking) context.getString(R.string.breaking) else context.getString(R.string.featured)
